...
import { loadSelectedOptionsSettled, } from "../../../src/exercises/day-04/035-load-selected-options-settled";
...
describe("loadSelectedOptionsSettled", () => {
    ...
    it("preserves first-seen order for multiple failures", async () => {
        ...
        await expect(loadSelectedOptionsSettled(["b", "a", "c", "b"], fetchUserById)).resolves.toEqual({
